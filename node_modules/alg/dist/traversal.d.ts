import { AlgPart, Unit, Sequence, Group, BlockMove, Commutator, Conjugate, Pause, NewLine, CommentShort, CommentLong } from "./algorithm";
...
export declare const algPartToStringForTesting: (a: AlgPart) => Sequence;
