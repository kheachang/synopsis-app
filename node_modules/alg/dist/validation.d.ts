import { Sequence, Group, BlockMove, Commutator, Conjugate, Pause, NewLine, CommentShort, CommentLong } from "./algorithm";
...
export declare const validateSiGNAlg: (a: Sequence) => void;
export {};
